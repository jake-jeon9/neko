...
--[[                                           ]]
Server.GetTopic("startMagicCooking").Add(function()
    jobMakingStart("magiccooking")
end)


Server.GetTopic("마법요리성공").Add(function(items,itemsCount)
    print("성공진입")
    local itemNumber = ItemList(items,itemsCount,"MAGICCOOKING")
...
Server.GetTopic("마법요리실패").Add(function(items,itemsCount)
    print("실패진입")
...
-----    아이템 리스트     -------
---------------------------------
theListOfMagicCooking  = {}
function listOfMagicCooking ()
    --print("리스트업 완료")
    local items = {}
    ...
    table.insert( theListOfMagicCooking , items )
	...
	local items = {}
    items["itemNumber"] = 96 -- 조이윙
    items["itemCount"] = 3
    items["rateOfSeccess"] = 0.1
    items["Data"] = {}
    
    local item1 = {}
    item1["itemNum"] = 140 -- 바요
    item1["count"] = 10
    
    local item2 = {}
    item2["itemNum"] = 37 -- 숭고한영혼
    item2["count"] = 1
	...
	local items = {}
    items["itemNumber"] = 539 -- 조이윙
    items["itemCount"] = 3
    items["rateOfSeccess"] = 0.1
    items["Data"] = {}
    
    local item1 = {}
    item1["itemNum"] = 540 -- 바요
    item1["count"] = 1
    
    local item2 = {}
    item2["itemNum"] = 15 -- 숭고한영혼
    item2["count"] = 10
	...
	local items = {}
    items["itemNumber"] = 548 -- 조이윙
    items["itemCount"] = 3
    items["rateOfSeccess"] = 0.1
    items["Data"] = {}
    
    local item1 = {}
    item1["itemNum"] = 549 -- 바요
    item1["count"] = 1
    ...
    local item2 = {}
    item2["itemNum"] = 170 -- 숭고한영혼
    item2["count"] = 10
    
    local item3 = {}
    item3["itemNum"] = 171 -- 호박
    item3["count"] = 10
	...
	local items = {}
    items["itemNumber"] = 1840 -- 왈츠옷
    items["itemCount"] = 3
    items["rateOfSeccess"] = 0.1
    items["Data"] = {}
    
    local item1 = {}
    item1["itemNum"] = 8 -- 실버코인
    item1["count"] = 10
    
    local item2 = {}
    item2["itemNum"] = 9 -- 골드코인
    item2["count"] = 10
    
    local item3 = {}
    item3["itemNum"] = 14 -- 아까비깡
    item3["count"] = 10
	...
	local items = {}
    items["itemNumber"] = 564 -- 카니발
    items["itemCount"] = 3
    items["rateOfSeccess"] = 0.1
    items["Data"] = {}
    
    local item1 = {}
    item1["itemNum"] = 565 -- 쩨베코스튬
    item1["count"] = 1
    
    local item2 = {}
    item2["itemNum"] = 8 -- 실버코인
    item2["count"] = 1
    
    local item3 = {}
    item3["itemNum"] = 9 -- 골드코인
    item3["count"] = 1
	...
	local items = {}
    items["itemNumber"] = 1981 -- 카니발
    items["itemCount"] = 3
    items["rateOfSeccess"] = 0.5
    items["Data"] = {}
    
    local item1 = {}
    item1["itemNum"] = 540 -- 쩨베코스튬
    item1["count"] = 1
    
    local item2 = {}
    item2["itemNum"] = 549 -- 실버코인
    item2["count"] = 1
    
    local item3 = {}
    item3["itemNum"] = 565 -- 골드코인
    item3["count"] = 1
	...
	local items = {}
    items["itemNumber"] = 2300 -- 도포
    items["itemCount"] = 3
    items["rateOfSeccess"] = 0.3
    items["Data"] = {}
    
    local item1 = {}
    item1["itemNum"] = 632 -- 쩨베코스튬
    item1["count"] = 1
